...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
     ...
     [
        ...
        buttons = [[
        InlineKeyboardButton('𝖣𝖪𝗑𝖡𝖮𝖳s', url='https://t.me/DKxBOTs'),
        InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='https://t.me/DKxSUPPORT'),
        InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='start')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.delete()
...
async def auto_filter(client, msg: pyrogram.types.Message, spoll=False):
    ...
    if offset != "":
        ...
        btn.append(
            [InlineKeyboardButton(text="ɴᴏ ᴘᴀɢᴇs ᴀᴠᴀɪʟᴀʙʟᴇ", callback_data="pages")]
        )
